...
if(document.addEventListener ){ 
   ...
   var include_folder = "wp-content/themes/bec3/include-anim/";

   aLoader = [
      { load: include_folder + "edge_includes/jquery-2.0.3.min.js"},
      { load: include_folder + "edge_includes/edge.4.0.0.min.js"},
      { load: include_folder + "testedge_edge.js"},
      { load: include_folder + "testedge_edgeActions.js"}];
...
var plSTF="width",ctrPlS="both",minPlW="0px",maxPlW="845px",plWidth="845px",plHeight="570px";
